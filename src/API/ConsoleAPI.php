...
class ConsoleAPI{
	...
	public function init(){
		...
		$this->register("help", "[页码|命令名称]", array($this, "defaultCommands"));
			...
			$output = "";
				switch($cmd){
					case "defaultgamemode":
						...
						$output .= "默认的游戏模式现在改为 ".strtoupper($this->server->getGamemode()).".\n";
						break;
					case "status":
					...
					case "help":
						...
						$output .= FORMAT_RED."-".FORMAT_RESET." 显示 第$page/$max 页 (/help <页码>) ".FORMAT_RED."-".FORMAT_RESET."\n";
						$current = 1;
						foreach($cmds as $c => $h){
